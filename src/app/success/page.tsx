...
const SuccessPage = () => {
  ...
  return (
    <div className='mx-auto -mt-[65px] flex min-h-screen w-full max-w-2xl flex-1 flex-col items-center justify-center rounded-md px-4 py-4 sm:px-8'>
      <svg
        width='51'
        height='50'
        viewBox='0 0 51 50'
      ...
      <header className='mb-8 mt-6 text-gray-900'>
        ...
        <p className='text-center text-lg font-medium leading-7'>
          Your Pre-Approval has been successfully submitted.
        </p>
      </header>
