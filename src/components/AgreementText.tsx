...
export default function AgreementText() {
  return (
    <p className='mx-1 mt-4 mb-8 rounded-[5px] border border-txtHintColor/20 bg-skin-base p-4 font-lato text-xs font-medium text-skin-label shadow-[#c7c9cb]  drop-shadow-sm backdrop-blur-2xl'>
      ...
      contacted by Everyday Motors. I understand that I might not prequalify depending on the
